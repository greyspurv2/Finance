...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=BTC&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=ETH&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=LTC&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=ETC&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=XRP&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=AAPL&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=GOOGL&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=SP500&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=BYND&apikey=JVQKTJDSYHG974CO", function(error, response, body));
...
request("https://www.alphavantage.co/query?function=TIME_SERIES_5min&symbol=TSLA&apikey=JVQKTJDSYHG974CO", function(error, response, body));
